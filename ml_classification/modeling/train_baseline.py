...
def main(
    ...
    """
    Day 6 – Baseline Training
    Train a Logistic Regression baseline on the Gold features table and log metrics & model in MLflow.
    """
    ...
    with mlflow.start_run():
        ...
        mlflow.sklearn.log_model(model, name="baseline_logreg", signature=signature, input_example=X_train.head(3))
    logger.success("Baseline Logistic Regression model registered in MLflow.")
